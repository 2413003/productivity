...
- Objective maps, draft task text, task order/ranking data, task notes, CRM, financial, personal, learn, proof, and profile settings are saved for the signed-in user.
